        ...
        <nav className="mt-4 relative max-w-2xl w-full bg-white border border-gray-200 rounded-[2rem] mx-2 py-2.5 md:flex md:items-center md:justify-between md:py-0 md:px-4 md:mx-auto dark:bg-neutral-900 dark:border-neutral-700">
          <div className="px-4 md:px-0 flex justify-between items-center">
            ...
            <div className="md:hidden">
              <button
                type="button"
                className="hs-collapse-toggle flex justify-center items-center size-6 border border-gray-200 text-gray-500 rounded-full hover:bg-gray-200 focus:outline-hidden focus:bg-gray-200 dark:border-neutral-700 dark:text-neutral-400 dark:hover:bg-neutral-700 dark:focus:bg-neutral-700"
        ...
        <div className="w-full max-w-2xl mx-auto pt-10 md:pt-16 px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-8">
            <p className="text-sm text-gray-600 dark:text-neutral-400">
              ...
              illustrations, helping clients bring their digital visions to
              life.
            </p>
            ...
            <div>
              ...
              <div className="group relative flex gap-x-5">
                ...
                <div className="grow pb-8 group-last:pb-0">
                  ...
                  <div className="mt-3">
                    <a
                      className="block border border-gray-200 rounded-lg hover:shadow-xs focus:outline-hidden dark:border-neutral-700"
                      href="#"
                    >
